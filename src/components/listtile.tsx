...
export default function ListTile({ todo }: { todo: Todo }) {
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.75, ease: "easeInOut" }} className="rounded-lg px-4 py-2 bg-neutral-100 flex justify-between mb-4 items-center">
      <div>
